...
$('.logo__name').hover(function () {
  $(this).addClass('magictime spaceInUp');
});

setInterval(function(){ 
	$('.logo__name').toggleClass('magictime spaceInUp');
}, 3000 );

$('.logo__slogan').hover(function () {
  $(this).addClass('magictime tinDownIn');
});

setInterval(function(){ 
	$('.logo__slogan').toggleClass('magictime tinDownIn');
}, 3000 );

$('.service-description__img').hover(function () {
